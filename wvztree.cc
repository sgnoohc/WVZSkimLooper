...
void wvztree::Init(TTree *tree) {
  ...
  looper_lep_Z_idx0_branch = tree->GetBranch("looper_lep_Z_idx0");
  if (looper_lep_Z_idx0_branch) looper_lep_Z_idx0_branch->SetAddress(&looper_lep_Z_idx0_);
  looper_lep_Z_idx1_branch = tree->GetBranch("looper_lep_Z_idx1");
  if (looper_lep_Z_idx1_branch) looper_lep_Z_idx1_branch->SetAddress(&looper_lep_Z_idx1_);
  looper_lep_N_idx0_branch = tree->GetBranch("looper_lep_N_idx0");
  if (looper_lep_N_idx0_branch) looper_lep_N_idx0_branch->SetAddress(&looper_lep_N_idx0_);
  looper_lep_N_idx1_branch = tree->GetBranch("looper_lep_N_idx1");
  if (looper_lep_N_idx1_branch) looper_lep_N_idx1_branch->SetAddress(&looper_lep_N_idx1_);
  looper_eventweight_branch = tree->GetBranch("looper_eventweight");
  if (looper_eventweight_branch) looper_eventweight_branch->SetAddress(&looper_eventweight_);
  looper_lepsf_branch = tree->GetBranch("looper_lepsf");
  if (looper_lepsf_branch) looper_lepsf_branch->SetAddress(&looper_lepsf_);
  looper_btagsf_branch = tree->GetBranch("looper_btagsf");
  if (looper_btagsf_branch) looper_btagsf_branch->SetAddress(&looper_btagsf_);
  looper_MllN_branch = tree->GetBranch("looper_MllN");
  if (looper_MllN_branch) looper_MllN_branch->SetAddress(&looper_MllN_);
  looper_MllZ_branch = tree->GetBranch("looper_MllZ");
  if (looper_MllZ_branch) looper_MllZ_branch->SetAddress(&looper_MllZ_);
  looper_ZPt_branch = tree->GetBranch("looper_ZPt");
  if (looper_ZPt_branch) looper_ZPt_branch->SetAddress(&looper_ZPt_);
  looper_lep1Pt_branch = tree->GetBranch("looper_lep1Pt");
  if (looper_lep1Pt_branch) looper_lep1Pt_branch->SetAddress(&looper_lep1Pt_);
  looper_lep2Pt_branch = tree->GetBranch("looper_lep2Pt");
  if (looper_lep2Pt_branch) looper_lep2Pt_branch->SetAddress(&looper_lep2Pt_);
  looper_lep3Pt_branch = tree->GetBranch("looper_lep3Pt");
  if (looper_lep3Pt_branch) looper_lep3Pt_branch->SetAddress(&looper_lep3Pt_);
  looper_lep4Pt_branch = tree->GetBranch("looper_lep4Pt");
  if (looper_lep4Pt_branch) looper_lep4Pt_branch->SetAddress(&looper_lep4Pt_);
  looper_lep3Id_branch = tree->GetBranch("looper_lep3Id");
  if (looper_lep3Id_branch) looper_lep3Id_branch->SetAddress(&looper_lep3Id_);
  looper_lep4Id_branch = tree->GetBranch("looper_lep4Id");
  if (looper_lep4Id_branch) looper_lep4Id_branch->SetAddress(&looper_lep4Id_);
  looper_lep3MT_branch = tree->GetBranch("looper_lep3MT");
  if (looper_lep3MT_branch) looper_lep3MT_branch->SetAddress(&looper_lep3MT_);
  looper_lep4MT_branch = tree->GetBranch("looper_lep4MT");
  if (looper_lep4MT_branch) looper_lep4MT_branch->SetAddress(&looper_lep4MT_);
  looper_lep34MT_branch = tree->GetBranch("looper_lep34MT");
  if (looper_lep34MT_branch) looper_lep34MT_branch->SetAddress(&looper_lep34MT_);
  looper_lep1dZ_branch = tree->GetBranch("looper_lep1dZ");
  if (looper_lep1dZ_branch) looper_lep1dZ_branch->SetAddress(&looper_lep1dZ_);
  looper_lep2dZ_branch = tree->GetBranch("looper_lep2dZ");
  if (looper_lep2dZ_branch) looper_lep2dZ_branch->SetAddress(&looper_lep2dZ_);
  looper_lep3dZ_branch = tree->GetBranch("looper_lep3dZ");
  if (looper_lep3dZ_branch) looper_lep3dZ_branch->SetAddress(&looper_lep3dZ_);
  looper_lep4dZ_branch = tree->GetBranch("looper_lep4dZ");
  if (looper_lep4dZ_branch) looper_lep4dZ_branch->SetAddress(&looper_lep4dZ_);
  looper_pt_zeta_branch = tree->GetBranch("looper_pt_zeta");
  if (looper_pt_zeta_branch) looper_pt_zeta_branch->SetAddress(&looper_pt_zeta_);
  looper_pt_zeta_vis_branch = tree->GetBranch("looper_pt_zeta_vis");
  if (looper_pt_zeta_vis_branch) looper_pt_zeta_vis_branch->SetAddress(&looper_pt_zeta_vis_);
  looper_pt_zeta_diff_branch = tree->GetBranch("looper_pt_zeta_diff");
  if (looper_pt_zeta_diff_branch) looper_pt_zeta_diff_branch->SetAddress(&looper_pt_zeta_diff_);
  looper_mt2_branch = tree->GetBranch("looper_mt2");
  if (looper_mt2_branch) looper_mt2_branch->SetAddress(&looper_mt2_);
  looper_phi0_branch = tree->GetBranch("looper_phi0");
  if (looper_phi0_branch) looper_phi0_branch->SetAddress(&looper_phi0_);
  looper_phi_branch = tree->GetBranch("looper_phi");
  if (looper_phi_branch) looper_phi_branch->SetAddress(&looper_phi_);
  looper_phiH_branch = tree->GetBranch("looper_phiH");
  if (looper_phiH_branch) looper_phiH_branch->SetAddress(&looper_phiH_);
  looper_theta0_branch = tree->GetBranch("looper_theta0");
  if (looper_theta0_branch) looper_theta0_branch->SetAddress(&looper_theta0_);
  looper_theta1_branch = tree->GetBranch("looper_theta1");
  if (looper_theta1_branch) looper_theta1_branch->SetAddress(&looper_theta1_);
  looper_theta2_branch = tree->GetBranch("looper_theta2");
  if (looper_theta2_branch) looper_theta2_branch->SetAddress(&looper_theta2_);
  looper_minDRJetToLep3_branch = tree->GetBranch("looper_minDRJetToLep3");
  if (looper_minDRJetToLep3_branch) looper_minDRJetToLep3_branch->SetAddress(&looper_minDRJetToLep3_);
  looper_minDRJetToLep4_branch = tree->GetBranch("looper_minDRJetToLep4");
  if (looper_minDRJetToLep4_branch) looper_minDRJetToLep4_branch->SetAddress(&looper_minDRJetToLep4_);
  looper_jet1Pt_branch = tree->GetBranch("looper_jet1Pt");
  if (looper_jet1Pt_branch) looper_jet1Pt_branch->SetAddress(&looper_jet1Pt_);
  looper_jet2Pt_branch = tree->GetBranch("looper_jet2Pt");
  if (looper_jet2Pt_branch) looper_jet2Pt_branch->SetAddress(&looper_jet2Pt_);
  looper_jet3Pt_branch = tree->GetBranch("looper_jet3Pt");
  if (looper_jet3Pt_branch) looper_jet3Pt_branch->SetAddress(&looper_jet3Pt_);
  looper_jet4Pt_branch = tree->GetBranch("looper_jet4Pt");
  if (looper_jet4Pt_branch) looper_jet4Pt_branch->SetAddress(&looper_jet4Pt_);
  looper_jet1BtagScore_branch = tree->GetBranch("looper_jet1BtagScore");
  if (looper_jet1BtagScore_branch) looper_jet1BtagScore_branch->SetAddress(&looper_jet1BtagScore_);
  looper_jet2BtagScore_branch = tree->GetBranch("looper_jet2BtagScore");
  if (looper_jet2BtagScore_branch) looper_jet2BtagScore_branch->SetAddress(&looper_jet2BtagScore_);
  looper_jet3BtagScore_branch = tree->GetBranch("looper_jet3BtagScore");
  if (looper_jet3BtagScore_branch) looper_jet3BtagScore_branch->SetAddress(&looper_jet3BtagScore_);
  looper_jet4BtagScore_branch = tree->GetBranch("looper_jet4BtagScore");
  if (looper_jet4BtagScore_branch) looper_jet4BtagScore_branch->SetAddress(&looper_jet4BtagScore_);
  ChannelEMu_branch = tree->GetBranch("ChannelEMu");
  if (ChannelEMu_branch) ChannelEMu_branch->SetAddress(&ChannelEMu_);
  ChannelOffZ_branch = tree->GetBranch("ChannelOffZ");
  if (ChannelOffZ_branch) ChannelOffZ_branch->SetAddress(&ChannelOffZ_);
  ChannelOnZ_branch = tree->GetBranch("ChannelOnZ");
  if (ChannelOnZ_branch) ChannelOnZ_branch->SetAddress(&ChannelOnZ_);
  ChannelBTagEMu_branch = tree->GetBranch("ChannelBTagEMu");
  if (ChannelBTagEMu_branch) ChannelBTagEMu_branch->SetAddress(&ChannelBTagEMu_);
...
void wvztree::GetEntry(unsigned int idx) {
  ...
  looper_lep_Z_idx0_isLoaded = false;
  looper_lep_Z_idx1_isLoaded = false;
  looper_lep_N_idx0_isLoaded = false;
  looper_lep_N_idx1_isLoaded = false;
  looper_eventweight_isLoaded = false;
  looper_lepsf_isLoaded = false;
  looper_btagsf_isLoaded = false;
  looper_MllN_isLoaded = false;
  looper_MllZ_isLoaded = false;
  looper_ZPt_isLoaded = false;
  looper_lep1Pt_isLoaded = false;
  looper_lep2Pt_isLoaded = false;
  looper_lep3Pt_isLoaded = false;
  looper_lep4Pt_isLoaded = false;
  looper_lep3Id_isLoaded = false;
  looper_lep4Id_isLoaded = false;
  looper_lep3MT_isLoaded = false;
  looper_lep4MT_isLoaded = false;
  looper_lep34MT_isLoaded = false;
  looper_lep1dZ_isLoaded = false;
  looper_lep2dZ_isLoaded = false;
  looper_lep3dZ_isLoaded = false;
  looper_lep4dZ_isLoaded = false;
  looper_pt_zeta_isLoaded = false;
  looper_pt_zeta_vis_isLoaded = false;
  looper_pt_zeta_diff_isLoaded = false;
  looper_mt2_isLoaded = false;
  looper_phi0_isLoaded = false;
  looper_phi_isLoaded = false;
  looper_phiH_isLoaded = false;
  looper_theta0_isLoaded = false;
  looper_theta1_isLoaded = false;
  looper_theta2_isLoaded = false;
  looper_minDRJetToLep3_isLoaded = false;
  looper_minDRJetToLep4_isLoaded = false;
  looper_jet1Pt_isLoaded = false;
  looper_jet2Pt_isLoaded = false;
  looper_jet3Pt_isLoaded = false;
  looper_jet4Pt_isLoaded = false;
  looper_jet1BtagScore_isLoaded = false;
  looper_jet2BtagScore_isLoaded = false;
  looper_jet3BtagScore_isLoaded = false;
  looper_jet4BtagScore_isLoaded = false;
  ChannelEMu_isLoaded = false;
  ChannelOffZ_isLoaded = false;
  ChannelOnZ_isLoaded = false;
  ChannelBTagEMu_isLoaded = false;
}
...
void wvztree::LoadAllBranches() {
  ...
  if (looper_lep_Z_idx0_branch != 0) looper_lep_Z_idx0();
  if (looper_lep_Z_idx1_branch != 0) looper_lep_Z_idx1();
  if (looper_lep_N_idx0_branch != 0) looper_lep_N_idx0();
  if (looper_lep_N_idx1_branch != 0) looper_lep_N_idx1();
  if (looper_eventweight_branch != 0) looper_eventweight();
  if (looper_lepsf_branch != 0) looper_lepsf();
  if (looper_btagsf_branch != 0) looper_btagsf();
  if (looper_MllN_branch != 0) looper_MllN();
  if (looper_MllZ_branch != 0) looper_MllZ();
  if (looper_ZPt_branch != 0) looper_ZPt();
  if (looper_lep1Pt_branch != 0) looper_lep1Pt();
  if (looper_lep2Pt_branch != 0) looper_lep2Pt();
  if (looper_lep3Pt_branch != 0) looper_lep3Pt();
  if (looper_lep4Pt_branch != 0) looper_lep4Pt();
  if (looper_lep3Id_branch != 0) looper_lep3Id();
  if (looper_lep4Id_branch != 0) looper_lep4Id();
  if (looper_lep3MT_branch != 0) looper_lep3MT();
  if (looper_lep4MT_branch != 0) looper_lep4MT();
  if (looper_lep34MT_branch != 0) looper_lep34MT();
  if (looper_lep1dZ_branch != 0) looper_lep1dZ();
  if (looper_lep2dZ_branch != 0) looper_lep2dZ();
  if (looper_lep3dZ_branch != 0) looper_lep3dZ();
  if (looper_lep4dZ_branch != 0) looper_lep4dZ();
  if (looper_pt_zeta_branch != 0) looper_pt_zeta();
  if (looper_pt_zeta_vis_branch != 0) looper_pt_zeta_vis();
  if (looper_pt_zeta_diff_branch != 0) looper_pt_zeta_diff();
  if (looper_mt2_branch != 0) looper_mt2();
  if (looper_phi0_branch != 0) looper_phi0();
  if (looper_phi_branch != 0) looper_phi();
  if (looper_phiH_branch != 0) looper_phiH();
  if (looper_theta0_branch != 0) looper_theta0();
  if (looper_theta1_branch != 0) looper_theta1();
  if (looper_theta2_branch != 0) looper_theta2();
  if (looper_minDRJetToLep3_branch != 0) looper_minDRJetToLep3();
  if (looper_minDRJetToLep4_branch != 0) looper_minDRJetToLep4();
  if (looper_jet1Pt_branch != 0) looper_jet1Pt();
  if (looper_jet2Pt_branch != 0) looper_jet2Pt();
  if (looper_jet3Pt_branch != 0) looper_jet3Pt();
  if (looper_jet4Pt_branch != 0) looper_jet4Pt();
  if (looper_jet1BtagScore_branch != 0) looper_jet1BtagScore();
  if (looper_jet2BtagScore_branch != 0) looper_jet2BtagScore();
  if (looper_jet3BtagScore_branch != 0) looper_jet3BtagScore();
  if (looper_jet4BtagScore_branch != 0) looper_jet4BtagScore();
  if (ChannelEMu_branch != 0) ChannelEMu();
  if (ChannelOffZ_branch != 0) ChannelOffZ();
  if (ChannelOnZ_branch != 0) ChannelOnZ();
  if (ChannelBTagEMu_branch != 0) ChannelBTagEMu();
}
...
const int &wvztree::looper_lep_Z_idx0() {
  if (not looper_lep_Z_idx0_isLoaded) {
    if (looper_lep_Z_idx0_branch != 0) {
      looper_lep_Z_idx0_branch->GetEntry(index);
    } else {
      printf("branch looper_lep_Z_idx0_branch does not exist!\n");
      exit(1);
    }
    looper_lep_Z_idx0_isLoaded = true;
  }
  return looper_lep_Z_idx0_;
}

const int &wvztree::looper_lep_Z_idx1() {
  if (not looper_lep_Z_idx1_isLoaded) {
    if (looper_lep_Z_idx1_branch != 0) {
      looper_lep_Z_idx1_branch->GetEntry(index);
    } else {
      printf("branch looper_lep_Z_idx1_branch does not exist!\n");
      exit(1);
    }
    looper_lep_Z_idx1_isLoaded = true;
  }
  return looper_lep_Z_idx1_;
}

const int &wvztree::looper_lep_N_idx0() {
  if (not looper_lep_N_idx0_isLoaded) {
    if (looper_lep_N_idx0_branch != 0) {
      looper_lep_N_idx0_branch->GetEntry(index);
    } else {
      printf("branch looper_lep_N_idx0_branch does not exist!\n");
      exit(1);
    }
    looper_lep_N_idx0_isLoaded = true;
  }
  return looper_lep_N_idx0_;
}

const int &wvztree::looper_lep_N_idx1() {
  if (not looper_lep_N_idx1_isLoaded) {
    if (looper_lep_N_idx1_branch != 0) {
      looper_lep_N_idx1_branch->GetEntry(index);
    } else {
      printf("branch looper_lep_N_idx1_branch does not exist!\n");
      exit(1);
    }
    looper_lep_N_idx1_isLoaded = true;
  }
  return looper_lep_N_idx1_;
}

const float &wvztree::looper_eventweight() {
  if (not looper_eventweight_isLoaded) {
    if (looper_eventweight_branch != 0) {
      looper_eventweight_branch->GetEntry(index);
    } else {
      printf("branch looper_eventweight_branch does not exist!\n");
      exit(1);
    }
    looper_eventweight_isLoaded = true;
  }
  return looper_eventweight_;
}

const float &wvztree::looper_lepsf() {
  if (not looper_lepsf_isLoaded) {
    if (looper_lepsf_branch != 0) {
      looper_lepsf_branch->GetEntry(index);
    } else {
      printf("branch looper_lepsf_branch does not exist!\n");
      exit(1);
    }
    looper_lepsf_isLoaded = true;
  }
  return looper_lepsf_;
}

const float &wvztree::looper_btagsf() {
  if (not looper_btagsf_isLoaded) {
    if (looper_btagsf_branch != 0) {
      looper_btagsf_branch->GetEntry(index);
    } else {
      printf("branch looper_btagsf_branch does not exist!\n");
      exit(1);
    }
    looper_btagsf_isLoaded = true;
  }
  return looper_btagsf_;
}

const float &wvztree::looper_MllN() {
  if (not looper_MllN_isLoaded) {
    if (looper_MllN_branch != 0) {
      looper_MllN_branch->GetEntry(index);
    } else {
      printf("branch looper_MllN_branch does not exist!\n");
      exit(1);
    }
    looper_MllN_isLoaded = true;
  }
  return looper_MllN_;
}

const float &wvztree::looper_MllZ() {
  if (not looper_MllZ_isLoaded) {
    if (looper_MllZ_branch != 0) {
      looper_MllZ_branch->GetEntry(index);
    } else {
      printf("branch looper_MllZ_branch does not exist!\n");
      exit(1);
    }
    looper_MllZ_isLoaded = true;
  }
  return looper_MllZ_;
}

const float &wvztree::looper_ZPt() {
  if (not looper_ZPt_isLoaded) {
    if (looper_ZPt_branch != 0) {
      looper_ZPt_branch->GetEntry(index);
    } else {
      printf("branch looper_ZPt_branch does not exist!\n");
      exit(1);
    }
    looper_ZPt_isLoaded = true;
  }
  return looper_ZPt_;
}

const float &wvztree::looper_lep1Pt() {
  if (not looper_lep1Pt_isLoaded) {
    if (looper_lep1Pt_branch != 0) {
      looper_lep1Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_lep1Pt_branch does not exist!\n");
      exit(1);
    }
    looper_lep1Pt_isLoaded = true;
  }
  return looper_lep1Pt_;
}

const float &wvztree::looper_lep2Pt() {
  if (not looper_lep2Pt_isLoaded) {
    if (looper_lep2Pt_branch != 0) {
      looper_lep2Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_lep2Pt_branch does not exist!\n");
      exit(1);
    }
    looper_lep2Pt_isLoaded = true;
  }
  return looper_lep2Pt_;
}

const float &wvztree::looper_lep3Pt() {
  if (not looper_lep3Pt_isLoaded) {
    if (looper_lep3Pt_branch != 0) {
      looper_lep3Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_lep3Pt_branch does not exist!\n");
      exit(1);
    }
    looper_lep3Pt_isLoaded = true;
  }
  return looper_lep3Pt_;
}

const float &wvztree::looper_lep4Pt() {
  if (not looper_lep4Pt_isLoaded) {
    if (looper_lep4Pt_branch != 0) {
      looper_lep4Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_lep4Pt_branch does not exist!\n");
      exit(1);
    }
    looper_lep4Pt_isLoaded = true;
  }
  return looper_lep4Pt_;
}

const float &wvztree::looper_lep3Id() {
  if (not looper_lep3Id_isLoaded) {
    if (looper_lep3Id_branch != 0) {
      looper_lep3Id_branch->GetEntry(index);
    } else {
      printf("branch looper_lep3Id_branch does not exist!\n");
      exit(1);
    }
    looper_lep3Id_isLoaded = true;
  }
  return looper_lep3Id_;
}

const float &wvztree::looper_lep4Id() {
  if (not looper_lep4Id_isLoaded) {
    if (looper_lep4Id_branch != 0) {
      looper_lep4Id_branch->GetEntry(index);
    } else {
      printf("branch looper_lep4Id_branch does not exist!\n");
      exit(1);
    }
    looper_lep4Id_isLoaded = true;
  }
  return looper_lep4Id_;
}

const float &wvztree::looper_lep3MT() {
  if (not looper_lep3MT_isLoaded) {
    if (looper_lep3MT_branch != 0) {
      looper_lep3MT_branch->GetEntry(index);
    } else {
      printf("branch looper_lep3MT_branch does not exist!\n");
      exit(1);
    }
    looper_lep3MT_isLoaded = true;
  }
  return looper_lep3MT_;
}

const float &wvztree::looper_lep4MT() {
  if (not looper_lep4MT_isLoaded) {
    if (looper_lep4MT_branch != 0) {
      looper_lep4MT_branch->GetEntry(index);
    } else {
      printf("branch looper_lep4MT_branch does not exist!\n");
      exit(1);
    }
    looper_lep4MT_isLoaded = true;
  }
  return looper_lep4MT_;
}

const float &wvztree::looper_lep34MT() {
  if (not looper_lep34MT_isLoaded) {
    if (looper_lep34MT_branch != 0) {
      looper_lep34MT_branch->GetEntry(index);
    } else {
      printf("branch looper_lep34MT_branch does not exist!\n");
      exit(1);
    }
    looper_lep34MT_isLoaded = true;
  }
  return looper_lep34MT_;
}

const float &wvztree::looper_lep1dZ() {
  if (not looper_lep1dZ_isLoaded) {
    if (looper_lep1dZ_branch != 0) {
      looper_lep1dZ_branch->GetEntry(index);
    } else {
      printf("branch looper_lep1dZ_branch does not exist!\n");
      exit(1);
    }
    looper_lep1dZ_isLoaded = true;
  }
  return looper_lep1dZ_;
}

const float &wvztree::looper_lep2dZ() {
  if (not looper_lep2dZ_isLoaded) {
    if (looper_lep2dZ_branch != 0) {
      looper_lep2dZ_branch->GetEntry(index);
    } else {
      printf("branch looper_lep2dZ_branch does not exist!\n");
      exit(1);
    }
    looper_lep2dZ_isLoaded = true;
  }
  return looper_lep2dZ_;
}

const float &wvztree::looper_lep3dZ() {
  if (not looper_lep3dZ_isLoaded) {
    if (looper_lep3dZ_branch != 0) {
      looper_lep3dZ_branch->GetEntry(index);
    } else {
      printf("branch looper_lep3dZ_branch does not exist!\n");
      exit(1);
    }
    looper_lep3dZ_isLoaded = true;
  }
  return looper_lep3dZ_;
}

const float &wvztree::looper_lep4dZ() {
  if (not looper_lep4dZ_isLoaded) {
    if (looper_lep4dZ_branch != 0) {
      looper_lep4dZ_branch->GetEntry(index);
    } else {
      printf("branch looper_lep4dZ_branch does not exist!\n");
      exit(1);
    }
    looper_lep4dZ_isLoaded = true;
  }
  return looper_lep4dZ_;
}

const float &wvztree::looper_pt_zeta() {
  if (not looper_pt_zeta_isLoaded) {
    if (looper_pt_zeta_branch != 0) {
      looper_pt_zeta_branch->GetEntry(index);
    } else {
      printf("branch looper_pt_zeta_branch does not exist!\n");
      exit(1);
    }
    looper_pt_zeta_isLoaded = true;
  }
  return looper_pt_zeta_;
}

const float &wvztree::looper_pt_zeta_vis() {
  if (not looper_pt_zeta_vis_isLoaded) {
    if (looper_pt_zeta_vis_branch != 0) {
      looper_pt_zeta_vis_branch->GetEntry(index);
    } else {
      printf("branch looper_pt_zeta_vis_branch does not exist!\n");
      exit(1);
    }
    looper_pt_zeta_vis_isLoaded = true;
  }
  return looper_pt_zeta_vis_;
}

const float &wvztree::looper_pt_zeta_diff() {
  if (not looper_pt_zeta_diff_isLoaded) {
    if (looper_pt_zeta_diff_branch != 0) {
      looper_pt_zeta_diff_branch->GetEntry(index);
    } else {
      printf("branch looper_pt_zeta_diff_branch does not exist!\n");
      exit(1);
    }
    looper_pt_zeta_diff_isLoaded = true;
  }
  return looper_pt_zeta_diff_;
}

const float &wvztree::looper_mt2() {
  if (not looper_mt2_isLoaded) {
    if (looper_mt2_branch != 0) {
      looper_mt2_branch->GetEntry(index);
    } else {
      printf("branch looper_mt2_branch does not exist!\n");
      exit(1);
    }
    looper_mt2_isLoaded = true;
  }
  return looper_mt2_;
}

const float &wvztree::looper_phi0() {
  if (not looper_phi0_isLoaded) {
    if (looper_phi0_branch != 0) {
      looper_phi0_branch->GetEntry(index);
    } else {
      printf("branch looper_phi0_branch does not exist!\n");
      exit(1);
    }
    looper_phi0_isLoaded = true;
  }
  return looper_phi0_;
}

const float &wvztree::looper_phi() {
  if (not looper_phi_isLoaded) {
    if (looper_phi_branch != 0) {
      looper_phi_branch->GetEntry(index);
    } else {
      printf("branch looper_phi_branch does not exist!\n");
      exit(1);
    }
    looper_phi_isLoaded = true;
  }
  return looper_phi_;
}

const float &wvztree::looper_phiH() {
  if (not looper_phiH_isLoaded) {
    if (looper_phiH_branch != 0) {
      looper_phiH_branch->GetEntry(index);
    } else {
      printf("branch looper_phiH_branch does not exist!\n");
      exit(1);
    }
    looper_phiH_isLoaded = true;
  }
  return looper_phiH_;
}

const float &wvztree::looper_theta0() {
  if (not looper_theta0_isLoaded) {
    if (looper_theta0_branch != 0) {
      looper_theta0_branch->GetEntry(index);
    } else {
      printf("branch looper_theta0_branch does not exist!\n");
      exit(1);
    }
    looper_theta0_isLoaded = true;
  }
  return looper_theta0_;
}

const float &wvztree::looper_theta1() {
  if (not looper_theta1_isLoaded) {
    if (looper_theta1_branch != 0) {
      looper_theta1_branch->GetEntry(index);
    } else {
      printf("branch looper_theta1_branch does not exist!\n");
      exit(1);
    }
    looper_theta1_isLoaded = true;
  }
  return looper_theta1_;
}

const float &wvztree::looper_theta2() {
  if (not looper_theta2_isLoaded) {
    if (looper_theta2_branch != 0) {
      looper_theta2_branch->GetEntry(index);
    } else {
      printf("branch looper_theta2_branch does not exist!\n");
      exit(1);
    }
    looper_theta2_isLoaded = true;
  }
  return looper_theta2_;
}

const float &wvztree::looper_minDRJetToLep3() {
  if (not looper_minDRJetToLep3_isLoaded) {
    if (looper_minDRJetToLep3_branch != 0) {
      looper_minDRJetToLep3_branch->GetEntry(index);
    } else {
      printf("branch looper_minDRJetToLep3_branch does not exist!\n");
      exit(1);
    }
    looper_minDRJetToLep3_isLoaded = true;
  }
  return looper_minDRJetToLep3_;
}

const float &wvztree::looper_minDRJetToLep4() {
  if (not looper_minDRJetToLep4_isLoaded) {
    if (looper_minDRJetToLep4_branch != 0) {
      looper_minDRJetToLep4_branch->GetEntry(index);
    } else {
      printf("branch looper_minDRJetToLep4_branch does not exist!\n");
      exit(1);
    }
    looper_minDRJetToLep4_isLoaded = true;
  }
  return looper_minDRJetToLep4_;
}

const float &wvztree::looper_jet1Pt() {
  if (not looper_jet1Pt_isLoaded) {
    if (looper_jet1Pt_branch != 0) {
      looper_jet1Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_jet1Pt_branch does not exist!\n");
      exit(1);
    }
    looper_jet1Pt_isLoaded = true;
  }
  return looper_jet1Pt_;
}

const float &wvztree::looper_jet2Pt() {
  if (not looper_jet2Pt_isLoaded) {
    if (looper_jet2Pt_branch != 0) {
      looper_jet2Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_jet2Pt_branch does not exist!\n");
      exit(1);
    }
    looper_jet2Pt_isLoaded = true;
  }
  return looper_jet2Pt_;
}

const float &wvztree::looper_jet3Pt() {
  if (not looper_jet3Pt_isLoaded) {
    if (looper_jet3Pt_branch != 0) {
      looper_jet3Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_jet3Pt_branch does not exist!\n");
      exit(1);
    }
    looper_jet3Pt_isLoaded = true;
  }
  return looper_jet3Pt_;
}

const float &wvztree::looper_jet4Pt() {
  if (not looper_jet4Pt_isLoaded) {
    if (looper_jet4Pt_branch != 0) {
      looper_jet4Pt_branch->GetEntry(index);
    } else {
      printf("branch looper_jet4Pt_branch does not exist!\n");
      exit(1);
    }
    looper_jet4Pt_isLoaded = true;
  }
  return looper_jet4Pt_;
}

const float &wvztree::looper_jet1BtagScore() {
  if (not looper_jet1BtagScore_isLoaded) {
    if (looper_jet1BtagScore_branch != 0) {
      looper_jet1BtagScore_branch->GetEntry(index);
    } else {
      printf("branch looper_jet1BtagScore_branch does not exist!\n");
      exit(1);
    }
    looper_jet1BtagScore_isLoaded = true;
  }
  return looper_jet1BtagScore_;
}

const float &wvztree::looper_jet2BtagScore() {
  if (not looper_jet2BtagScore_isLoaded) {
    if (looper_jet2BtagScore_branch != 0) {
      looper_jet2BtagScore_branch->GetEntry(index);
    } else {
      printf("branch looper_jet2BtagScore_branch does not exist!\n");
      exit(1);
    }
    looper_jet2BtagScore_isLoaded = true;
  }
  return looper_jet2BtagScore_;
}

const float &wvztree::looper_jet3BtagScore() {
  if (not looper_jet3BtagScore_isLoaded) {
    if (looper_jet3BtagScore_branch != 0) {
      looper_jet3BtagScore_branch->GetEntry(index);
    } else {
      printf("branch looper_jet3BtagScore_branch does not exist!\n");
      exit(1);
    }
    looper_jet3BtagScore_isLoaded = true;
  }
  return looper_jet3BtagScore_;
}

const float &wvztree::looper_jet4BtagScore() {
  if (not looper_jet4BtagScore_isLoaded) {
    if (looper_jet4BtagScore_branch != 0) {
      looper_jet4BtagScore_branch->GetEntry(index);
    } else {
      printf("branch looper_jet4BtagScore_branch does not exist!\n");
      exit(1);
    }
    looper_jet4BtagScore_isLoaded = true;
  }
  return looper_jet4BtagScore_;
}

const int &wvztree::ChannelEMu() {
  if (not ChannelEMu_isLoaded) {
    if (ChannelEMu_branch != 0) {
      ChannelEMu_branch->GetEntry(index);
    } else {
      printf("branch ChannelEMu_branch does not exist!\n");
      exit(1);
    }
    ChannelEMu_isLoaded = true;
  }
  return ChannelEMu_;
}

const int &wvztree::ChannelOffZ() {
  if (not ChannelOffZ_isLoaded) {
    if (ChannelOffZ_branch != 0) {
      ChannelOffZ_branch->GetEntry(index);
    } else {
      printf("branch ChannelOffZ_branch does not exist!\n");
      exit(1);
    }
    ChannelOffZ_isLoaded = true;
  }
  return ChannelOffZ_;
}

const int &wvztree::ChannelOnZ() {
  if (not ChannelOnZ_isLoaded) {
    if (ChannelOnZ_branch != 0) {
      ChannelOnZ_branch->GetEntry(index);
    } else {
      printf("branch ChannelOnZ_branch does not exist!\n");
      exit(1);
    }
    ChannelOnZ_isLoaded = true;
  }
  return ChannelOnZ_;
}

const int &wvztree::ChannelBTagEMu() {
  if (not ChannelBTagEMu_isLoaded) {
    if (ChannelBTagEMu_branch != 0) {
      ChannelBTagEMu_branch->GetEntry(index);
    } else {
      printf("branch ChannelBTagEMu_branch does not exist!\n");
      exit(1);
    }
    ChannelBTagEMu_isLoaded = true;
  }
  return ChannelBTagEMu_;
}
...
const int &looper_lep_Z_idx0() { return wvz.looper_lep_Z_idx0(); }
const int &looper_lep_Z_idx1() { return wvz.looper_lep_Z_idx1(); }
const int &looper_lep_N_idx0() { return wvz.looper_lep_N_idx0(); }
const int &looper_lep_N_idx1() { return wvz.looper_lep_N_idx1(); }
const float &looper_eventweight() { return wvz.looper_eventweight(); }
const float &looper_lepsf() { return wvz.looper_lepsf(); }
const float &looper_btagsf() { return wvz.looper_btagsf(); }
const float &looper_MllN() { return wvz.looper_MllN(); }
const float &looper_MllZ() { return wvz.looper_MllZ(); }
const float &looper_ZPt() { return wvz.looper_ZPt(); }
const float &looper_lep1Pt() { return wvz.looper_lep1Pt(); }
const float &looper_lep2Pt() { return wvz.looper_lep2Pt(); }
const float &looper_lep3Pt() { return wvz.looper_lep3Pt(); }
const float &looper_lep4Pt() { return wvz.looper_lep4Pt(); }
const float &looper_lep3Id() { return wvz.looper_lep3Id(); }
const float &looper_lep4Id() { return wvz.looper_lep4Id(); }
const float &looper_lep3MT() { return wvz.looper_lep3MT(); }
const float &looper_lep4MT() { return wvz.looper_lep4MT(); }
const float &looper_lep34MT() { return wvz.looper_lep34MT(); }
const float &looper_lep1dZ() { return wvz.looper_lep1dZ(); }
const float &looper_lep2dZ() { return wvz.looper_lep2dZ(); }
const float &looper_lep3dZ() { return wvz.looper_lep3dZ(); }
const float &looper_lep4dZ() { return wvz.looper_lep4dZ(); }
const float &looper_pt_zeta() { return wvz.looper_pt_zeta(); }
const float &looper_pt_zeta_vis() { return wvz.looper_pt_zeta_vis(); }
const float &looper_pt_zeta_diff() { return wvz.looper_pt_zeta_diff(); }
const float &looper_mt2() { return wvz.looper_mt2(); }
const float &looper_phi0() { return wvz.looper_phi0(); }
const float &looper_phi() { return wvz.looper_phi(); }
const float &looper_phiH() { return wvz.looper_phiH(); }
const float &looper_theta0() { return wvz.looper_theta0(); }
const float &looper_theta1() { return wvz.looper_theta1(); }
const float &looper_theta2() { return wvz.looper_theta2(); }
const float &looper_minDRJetToLep3() { return wvz.looper_minDRJetToLep3(); }
const float &looper_minDRJetToLep4() { return wvz.looper_minDRJetToLep4(); }
const float &looper_jet1Pt() { return wvz.looper_jet1Pt(); }
const float &looper_jet2Pt() { return wvz.looper_jet2Pt(); }
const float &looper_jet3Pt() { return wvz.looper_jet3Pt(); }
const float &looper_jet4Pt() { return wvz.looper_jet4Pt(); }
const float &looper_jet1BtagScore() { return wvz.looper_jet1BtagScore(); }
const float &looper_jet2BtagScore() { return wvz.looper_jet2BtagScore(); }
const float &looper_jet3BtagScore() { return wvz.looper_jet3BtagScore(); }
const float &looper_jet4BtagScore() { return wvz.looper_jet4BtagScore(); }
const int &ChannelEMu() { return wvz.ChannelEMu(); }
const int &ChannelOffZ() { return wvz.ChannelOffZ(); }
const int &ChannelOnZ() { return wvz.ChannelOnZ(); }
const int &ChannelBTagEMu() { return wvz.ChannelBTagEMu(); }
