...
// makeCMS3ClassFiles("/home/users/phchang/public_html/analysis/wvz/WVZLooper/scripts/skim_looper/WVZMVAAllYearSkim4RegionsV2_v0.1.15/wwz.root", "t", "wvztree", "cms", "wvz")
...
class wvztree {
 ...
 protected: 
  ...
  int      looper_lep_Z_idx0_;
  TBranch *looper_lep_Z_idx0_branch;
  bool     looper_lep_Z_idx0_isLoaded;
  int      looper_lep_Z_idx1_;
  TBranch *looper_lep_Z_idx1_branch;
  bool     looper_lep_Z_idx1_isLoaded;
  int      looper_lep_N_idx0_;
  TBranch *looper_lep_N_idx0_branch;
  bool     looper_lep_N_idx0_isLoaded;
  int      looper_lep_N_idx1_;
  TBranch *looper_lep_N_idx1_branch;
  bool     looper_lep_N_idx1_isLoaded;
  float    looper_eventweight_;
  TBranch *looper_eventweight_branch;
  bool     looper_eventweight_isLoaded;
  float    looper_lepsf_;
  TBranch *looper_lepsf_branch;
  bool     looper_lepsf_isLoaded;
  float    looper_btagsf_;
  TBranch *looper_btagsf_branch;
  bool     looper_btagsf_isLoaded;
  float    looper_MllN_;
  TBranch *looper_MllN_branch;
  bool     looper_MllN_isLoaded;
  float    looper_MllZ_;
  TBranch *looper_MllZ_branch;
  bool     looper_MllZ_isLoaded;
  float    looper_ZPt_;
  TBranch *looper_ZPt_branch;
  bool     looper_ZPt_isLoaded;
  float    looper_lep1Pt_;
  TBranch *looper_lep1Pt_branch;
  bool     looper_lep1Pt_isLoaded;
  float    looper_lep2Pt_;
  TBranch *looper_lep2Pt_branch;
  bool     looper_lep2Pt_isLoaded;
  float    looper_lep3Pt_;
  TBranch *looper_lep3Pt_branch;
  bool     looper_lep3Pt_isLoaded;
  float    looper_lep4Pt_;
  TBranch *looper_lep4Pt_branch;
  bool     looper_lep4Pt_isLoaded;
  float    looper_lep3Id_;
  TBranch *looper_lep3Id_branch;
  bool     looper_lep3Id_isLoaded;
  float    looper_lep4Id_;
  TBranch *looper_lep4Id_branch;
  bool     looper_lep4Id_isLoaded;
  float    looper_lep3MT_;
  TBranch *looper_lep3MT_branch;
  bool     looper_lep3MT_isLoaded;
  float    looper_lep4MT_;
  TBranch *looper_lep4MT_branch;
  bool     looper_lep4MT_isLoaded;
  float    looper_lep34MT_;
  TBranch *looper_lep34MT_branch;
  bool     looper_lep34MT_isLoaded;
  float    looper_lep1dZ_;
  TBranch *looper_lep1dZ_branch;
  bool     looper_lep1dZ_isLoaded;
  float    looper_lep2dZ_;
  TBranch *looper_lep2dZ_branch;
  bool     looper_lep2dZ_isLoaded;
  float    looper_lep3dZ_;
  TBranch *looper_lep3dZ_branch;
  bool     looper_lep3dZ_isLoaded;
  float    looper_lep4dZ_;
  TBranch *looper_lep4dZ_branch;
  bool     looper_lep4dZ_isLoaded;
  float    looper_pt_zeta_;
  TBranch *looper_pt_zeta_branch;
  bool     looper_pt_zeta_isLoaded;
  float    looper_pt_zeta_vis_;
  TBranch *looper_pt_zeta_vis_branch;
  bool     looper_pt_zeta_vis_isLoaded;
  float    looper_pt_zeta_diff_;
  TBranch *looper_pt_zeta_diff_branch;
  bool     looper_pt_zeta_diff_isLoaded;
  float    looper_mt2_;
  TBranch *looper_mt2_branch;
  bool     looper_mt2_isLoaded;
  float    looper_phi0_;
  TBranch *looper_phi0_branch;
  bool     looper_phi0_isLoaded;
  float    looper_phi_;
  TBranch *looper_phi_branch;
  bool     looper_phi_isLoaded;
  float    looper_phiH_;
  TBranch *looper_phiH_branch;
  bool     looper_phiH_isLoaded;
  float    looper_theta0_;
  TBranch *looper_theta0_branch;
  bool     looper_theta0_isLoaded;
  float    looper_theta1_;
  TBranch *looper_theta1_branch;
  bool     looper_theta1_isLoaded;
  float    looper_theta2_;
  TBranch *looper_theta2_branch;
  bool     looper_theta2_isLoaded;
  float    looper_minDRJetToLep3_;
  TBranch *looper_minDRJetToLep3_branch;
  bool     looper_minDRJetToLep3_isLoaded;
  float    looper_minDRJetToLep4_;
  TBranch *looper_minDRJetToLep4_branch;
  bool     looper_minDRJetToLep4_isLoaded;
  float    looper_jet1Pt_;
  TBranch *looper_jet1Pt_branch;
  bool     looper_jet1Pt_isLoaded;
  float    looper_jet2Pt_;
  TBranch *looper_jet2Pt_branch;
  bool     looper_jet2Pt_isLoaded;
  float    looper_jet3Pt_;
  TBranch *looper_jet3Pt_branch;
  bool     looper_jet3Pt_isLoaded;
  float    looper_jet4Pt_;
  TBranch *looper_jet4Pt_branch;
  bool     looper_jet4Pt_isLoaded;
  float    looper_jet1BtagScore_;
  TBranch *looper_jet1BtagScore_branch;
  bool     looper_jet1BtagScore_isLoaded;
  float    looper_jet2BtagScore_;
  TBranch *looper_jet2BtagScore_branch;
  bool     looper_jet2BtagScore_isLoaded;
  float    looper_jet3BtagScore_;
  TBranch *looper_jet3BtagScore_branch;
  bool     looper_jet3BtagScore_isLoaded;
  float    looper_jet4BtagScore_;
  TBranch *looper_jet4BtagScore_branch;
  bool     looper_jet4BtagScore_isLoaded;
  int      ChannelEMu_;
  TBranch *ChannelEMu_branch;
  bool     ChannelEMu_isLoaded;
  int      ChannelOffZ_;
  TBranch *ChannelOffZ_branch;
  bool     ChannelOffZ_isLoaded;
  int      ChannelOnZ_;
  TBranch *ChannelOnZ_branch;
  bool     ChannelOnZ_isLoaded;
  int      ChannelBTagEMu_;
  TBranch *ChannelBTagEMu_branch;
  bool     ChannelBTagEMu_isLoaded;
public: 
...
void LoadAllBranches(); 
  ...
  const int &looper_lep_Z_idx0();
  const int &looper_lep_Z_idx1();
  const int &looper_lep_N_idx0();
  const int &looper_lep_N_idx1();
  const float &looper_eventweight();
  const float &looper_lepsf();
  const float &looper_btagsf();
  const float &looper_MllN();
  const float &looper_MllZ();
  const float &looper_ZPt();
  const float &looper_lep1Pt();
  const float &looper_lep2Pt();
  const float &looper_lep3Pt();
  const float &looper_lep4Pt();
  const float &looper_lep3Id();
  const float &looper_lep4Id();
  const float &looper_lep3MT();
  const float &looper_lep4MT();
  const float &looper_lep34MT();
  const float &looper_lep1dZ();
  const float &looper_lep2dZ();
  const float &looper_lep3dZ();
  const float &looper_lep4dZ();
  const float &looper_pt_zeta();
  const float &looper_pt_zeta_vis();
  const float &looper_pt_zeta_diff();
  const float &looper_mt2();
  const float &looper_phi0();
  const float &looper_phi();
  const float &looper_phiH();
  const float &looper_theta0();
  const float &looper_theta1();
  const float &looper_theta2();
  const float &looper_minDRJetToLep3();
  const float &looper_minDRJetToLep4();
  const float &looper_jet1Pt();
  const float &looper_jet2Pt();
  const float &looper_jet3Pt();
  const float &looper_jet4Pt();
  const float &looper_jet1BtagScore();
  const float &looper_jet2BtagScore();
  const float &looper_jet3BtagScore();
  const float &looper_jet4BtagScore();
  const int &ChannelEMu();
  const int &ChannelOffZ();
  const int &ChannelOnZ();
  const int &ChannelBTagEMu();
